...
**Problem:** REST API vs GraphQL 실무 선택
**Models:** mock
**Mode:** simple (3 rounds)
**Date:** 2025년 11월  1일 토 오후 12:01:06
...
... (full response in ./e2e-test-5/rounds/round1_mock_response.txt)
...
... (full response in ./e2e-test-5/rounds/round2_mock_response.txt)
...
... (full response in ./e2e-test-5/rounds/round3_mock_response.txt)
